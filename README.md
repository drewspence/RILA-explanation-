...
### Snapshot behavior and tolerances

Visual snapshots use a small tolerance to reduce false positives from anti-aliasing while still catching meaningful regressions:
